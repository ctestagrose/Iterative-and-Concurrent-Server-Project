...
class State {
	...
	/**
	 * The setDeathRate method will set the deathRate of the state 
	 * 
	 * @param deathRate this parameter is calculated and then passed to this method
	 */
	...
	/**
	 * The getDeathRate method will return the deathRate of the state object
	 * 
	 * @return the deathRate of the state object
	 */
	...
	/**
	 * This method will set the priority of the state object after it is passed from the calling method
	 * 
	 * @param priority
	 */
    ...
    /**
     * This method will retunr the priority of the state object
     * 
     * @return
     */
